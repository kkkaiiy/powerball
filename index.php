...
<!-- 외부소스 -->
<script type="text/javascript" src="http://103.1.250.9/eos_5min_powerball.json"></script>
</head>
<body>

	<script>
		var is_mobile = "0";
		var servername = "http://103.1.250.9/eos_5min_powerball.json";
		...
		var game_round = "1175371";

		var game_ground = "108";

		var pre_game_round = "1175370";
		...
		function get_svtime() {
			$.ajax({
				type:"post",
				url:'http://103.1.250.9/eos_5min_powerball.json',
				data:{flag:"get_time"},
	...
	<div id="wrap" class="g_area">
		<!--버튼영역-->
			<div class="g_btn">
				<a href="http://103.1.250.9/eos_5min_powerball.json" class="g_btn_1 g_btn_dft" target="_blank" title="워싱턴닷컴홈가기">워싱턴닷컴홈가기</a>
		...
		<div class="g_box">
			...
			<div class="g_pop" id="pop_game_guide" style="display:none;">
				<div>
					...
					<p class="tit">게임가이드</p>
					<p class="cont">
						워싱턴 파워볼의 결과값을 기준으로 5분단위로 적용합니다.<br />
						워싱턴 내역보기 https://dhlottery.co.kr
					</p>
				</div>	
			</div>
			<!-- //게임가이드-->
			...
			<div class="clearfix game">
				...
				<div id="game_zone" class="power_wrap">	
					...
					<div class="power_info"> 
						<h2 class="tit" style="display:none"><span id="btm_curr_num">1175371</span>회차 결과</h2>
					...
					<div class="power_before_info" id="prepare_box">
						<h3 class="tit">
							제 <span id="powerball_round_number">1175371</span> 회 <br />
							<span id="powerball_ground_number" style="line-height:28px;">108</span> 회
						</h3>
						<p class="time"><span id="r_mm">00</span> : <span id="r_ss">00</span></p>
						<!--p class="txt">
						워싱턴의 파워볼을 기준으로 5분 단위로 추첨하여<br/>288회차까지 진행
						</p-->
					</div>
					<!-- //게임 시작전 안내  -->
				...
				<div class="game_result coin">
					...
					<div id="gtab1">
						<div class="result_month" style="height:426px;">
							<ul class="result_list4">
									...
									<strong><span id="ready_game_round" style="display:inline-block;">108 (1175371)</span>&nbsp;&nbsp;대기중</strong>
								</li-->
										<li>
									...
									<p class="img">
										...
										<li>
									<span class="tit">256 (1175087)</span>
									<p class="img">
										<img src="imgs/card/card_ball_02.png" alt="02" style="width:20px;"/>
										<img src="imgs/card/card_ball_17.png" alt="17" style="width:20px;"/>
										<img src="imgs/card/card_ball_13.png" alt="13" style="width:20px;"/>
										...
										<li>
									<span class="tit">255 (1175086)</span>
									<p class="img">
										<img src="imgs/card/card_ball_16.png" alt="16" style="width:20px;"/>
										<img src="imgs/card/card_ball_22.png" alt="22" style="width:20px;"/>
										<img src="imgs/card/card_ball_04.png" alt="04" style="width:20px;"/>
										...
										<li>
									<span class="tit">254 (1175085)</span>
									<p class="img">
										<img src="imgs/card/card_ball_21.png" alt="21" style="width:20px;"/>
										<img src="imgs/card/card_ball_02.png" alt="02" style="width:20px;"/>
										<img src="imgs/card/card_ball_12.png" alt="12" style="width:20px;"/>
										...
										<li>
									<span class="tit">253 (1175084)</span>
									<p class="img">
										<img src="imgs/card/card_ball_08.png" alt="08" style="width:20px;"/>
										<img src="imgs/card/card_ball_22.png" alt="22" style="width:20px;"/>
										<img src="imgs/card/card_ball_16.png" alt="16" style="width:20px;"/>
										...
										<li>
									<span class="tit">252 (1175083)</span>
									<p class="img">
										<img src="imgs/card/card_ball_28.png" alt="28" style="width:20px;"/>
										<img src="imgs/card/card_ball_09.png" alt="09" style="width:20px;"/>
										<img src="imgs/card/card_ball_18.png" alt="18" style="width:20px;"/>
					...
					<div class="g_link2">
						<ul>
							<li><a href="http://103.1.250.9/eos_5min_powerball.json/game_powerball_date.php" target="_blank">일별</a></li>
							<li><a href="http://103.1.250.9/eos_5min_powerball.json/game_powerball_round.php" target="_blank">회차</a></li>						
							<li><a href="http://103.1.250.9/eos_5min_powerball.json/game_powerball_pattern.php" target="_blank">패턴</a></li>
							<!--li><a href="http://103.1.250.9/eos_5min_powerball.json/ready.php" target="_blank">예측</a></li-->						
							<li><a href="http://103.1.250.9/eos_5min_powerball.json/godpick/sv01_powerball.php" target="_blank">갓픽</a></li>
							<!--li><a href="http://103.1.250.9/eos_5min_powerball.json/ready.php" target="_blank">한눈</a></li-->
						</ul>
					</div>
